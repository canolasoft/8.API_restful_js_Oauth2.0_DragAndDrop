...
<div class="container bg-dark text-light rounded-3 p-5 mt-3 text-center">
    ...
    <div class="row">
        <img id="imagen" class="col-md-6 col-lg-4 mx-auto" src="" alt="imagen de perfil">
    </div>
...
<div class="container text-center">
    ...
    <form id="configForm" class="col-lg-6 my-4 bg-light text-dark p-4 rounded">
        <div class="mb-3">
            <label for="num_players" class="form-label">Número de jugadores (2-4) <strong
                    class="text-danger">*</strong></label>
            <input type="number" class="form-control" id="num_players" name="num_players" min="2" max="4" value="2"
                required>
        </div>
        <div class="mb-3">
            <label for="num_turns" class="form-label">Número de turnos (5-20) <strong
                    class="text-danger">*</strong></label>
            <input type="number" class="form-control" id="num_turns" name="num_turns" min="5" max="20" value="10"
                required>
        </div>
        <div class="row">
...
<script>
    ...
    .then(data => {
        if (data.success) {
            ...
            document.getElementById('imagen').src = '../API/uploads/' + imagen;
        }
    })
    .catch(error => {
