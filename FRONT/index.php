...
?>
    <div id="inicio" class="px-4 pt-5 my-5 text-center">
        ...
        <a href="test.html" class="btn btn-success btn-lg mb-3">Iniciar prueba</a>
        <br>
        <a href="https://misutmeeple.com/2019/08/resena-draftosaurus/" target="_blank">Ver reglas</a>
